...
a = lambda x: determine_language(x) == "japanese"

# 要输出返回的内容，需要调用这个lambda函数
inputs_example = {"query": "我想学日语"}
print(a(inputs_example))  # 输出: True

inputs_example2 = {"query": "我想学英语"}
print(a(inputs_example2))  # 输出: False
